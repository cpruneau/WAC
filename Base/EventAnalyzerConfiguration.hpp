 ...
 **********************************************************************/
#ifndef WAC_EventAnalyzerConfiguration
#define WAC_EventAnalyzerConfiguration
#include "TMath.h"
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
class EventAnalyzerConfiguration : public TaskConfiguration
{
public:
  
  EventAnalyzerConfiguration(const TString & name,
                        const TString & type,
                        const TString & version);
  EventAnalyzerConfiguration(const EventAnalyzerConfiguration & source);
  virtual ~EventAnalyzerConfiguration(){}

  EventAnalyzerConfiguration & operator=(const EventAnalyzerConfiguration & source);
...
ClassDef(EventAnalyzerConfiguration,0)
};

#endif /* WAC_EventAnalyzerConfiguration */
